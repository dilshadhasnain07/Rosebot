# https://github.com/dilshadhasnain07/Rosebot
...
class Config(object):
    ...
    BL_CHATS = -1002105665930

    # User IDs of sudo users, dev users, support users, tiger users, and whitelist users
    DRAGONS = 6346273488  # Sudo users
    DEV_USERS = 6346273488  # Dev users
    DEMONS = 6346273488  # Support users
    TIGERS = 6346273488  # Tiger users
    WOLVES = 6346273488  # Whitelist users
